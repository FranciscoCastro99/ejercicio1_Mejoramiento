...
<body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="{{route('project.create')}}">Crear</a>
                </li>
            </ul>
          </div>
        </div>
    ...
    <div class="d-flex justify-content-center align-items-center flex-column" style="height: calc(100vh - 56px);">
        ...
        <form class="w-25" action="{{route('project.store')}}" method="post">
            @csrf
            ...
            <div class="form-floating mb-3">
                <input name="fechaDeInicio" type="date" class="form-control" id="fechaDeInicio" placeholder="Fecha De Inicio">
                <label for="fechaDeInicio">Fecha De Inicio</label>
            </div>

            <div class="form-floating">
                <select id="client_id" name="client_id" class="form-select mb-3"  form="formulario" aria-label="Floating label select example">
