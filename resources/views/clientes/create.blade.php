...
<body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="{{route('client.create')}}">Crear</a>
                </li>
            </ul>
          </div>
        </div>
    ...
    <div class="d-flex justify-content-center align-items-center flex-column" style="height: calc(100vh - 56px);">
        ...
        <form class="w-25" action="{{route('client.store')}}" method="post">
            @csrf
            ...
            <div class="form-floating mb-3">
                <input name="num_social" type="text" class="form-control" id="num_social" placeholder="num_social">
